...
>
> **Stable path:** `documentation/reference/gsl-sysml-v2-syntax-reference.md` — always the current version.
> **Versioned snapshots:** `documentation/reference/syntax-versions/`
>
> **Companion documents:**
...
Previous versions preserved in `documentation/reference/syntax-versions/`.

---

*Restructured 8 March 2026 (Session 8). Updated 15 March 2026 (Sessions 29–31, CSW Phase 10 + Concept Graph + Knowledge Graph Enhancement). Updated 19 March 2026 (Session 38, Ontara Stage 2 Phase 1: metadata annotation conventions). Updated 19 March 2026 (Session 42, Stage 2 Phase 6: governance traceability — metadata on requirement def, cross-package satisfy, constraint def Boolean operators). Reorganised 19 March 2026 (Session 44): stable filename adopted — `gsl-sysml-v2-syntax-reference.md` (no version in filename). Versioned snapshots in `syntax-versions/`.*
